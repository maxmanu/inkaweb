...
<!--faq section -->
<section class="faq-section pt-50 pb-120">
  <div class="container">
            ...
            <ul class="hm2-server-tab-control nav nav-tabs border-0">
              <li>
                <button class="active" data-bs-toggle="tab" data-bs-target="#faq_shared_hosting">
                  <i class="fa-solid fa-server"></i><span class="ms-3">Shared Hosting</span>
                </button>
              </li>
              <li>
                <button data-bs-toggle="tab" data-bs-target="#faq_wp_hosting">
                  <i class="fa-brands fa-wordpress"></i><span class="ms-3">WordPress Hosting</span>
                </button>
              </li>
              <li>
                <button data-bs-toggle="tab" data-bs-target="#faq_vps_hosting">
                  <i class="fa-solid fa-database"></i><span class="ms-3">Vps Hosting</span>
                </button>
              </li>
              <li>
                <button data-bs-toggle="tab" data-bs-target="#faq_could_hosting">
                  <i class="fa-solid fa-cloud-meatball"></i><span class="ms-3">Dedicated Hosting</span>
                </button>
              </li>
            </ul>
          </div>
                ...
                <div class="accordion-item">
                  ...
                  <div class="accordion-collapse collapse show" id="sh_1" data-bs-parent="#accordion_1">
                    <div class="accordion-body">
                      <p class="mb-0">
                        We care about safety big time — and so do your site's visitors. With a Shared Hosting
                        account, you get an SSL certificate for free to add to your site. In this day and age,
                        having an SSL for your site is a no-brainer best practice. Not only does an SSL help your
                        visitors feel safe interacting with your site — this is particularly important if you run
                        an e-commerce site.
                      </p>
                    </div>
                  </div>
...
<!--feedback area start-->
<section class="dm-feedback pt-120 pb-120">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-6">
        <div class="dm-feedback-left text-center">
          <h2>Tutoriales más buscados</h2>
        </div>
      </div>
    </div>
    <div class="row pt-50">
      <div class="col-lg-4">
        <div class="title-tuto-cat mx-auto">
          <i class="fa-solid fa-gear"></i><span class="ms-3">Generales</span>
        </div>
      ...
      <div class="col-lg-4">
        <div class="title-tuto-cat mx-auto">
          <i class="fa-solid fa-server"></i><span class="ms-3">Hosting</span>
        </div>
        <div class="hosting-info-column hosting-info-column--tuto bg-white rounded-2 mx-auto">
          <ul class="hostim-info-list mb-30">
            <li>
      ...
      <div class="col-lg-4">
        <div class="title-tuto-cat mx-auto">
          <i class="fa-solid fa-shield"></i><span class="ms-3">Seguridad</span>
        </div>
        <div class="hosting-info-column hosting-info-column--tuto bg-white rounded-2 mx-auto">
          <ul class="hostim-info-list mb-30">
            <li>
