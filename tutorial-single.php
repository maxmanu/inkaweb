      ...
      <div class="col-xl-4">
        <div class="hm-blog-sidebar mt-4 mt-xl-0">
          ...
          <div class="sidebar-widget categories-widget">
            ...
            <ul class="mt-30">
              <li><a href="tutorial-category.php">Cloud Hosting<sup>(05)</sup></a></li>
              <li><a href="tutorial-category.php">Dedicated Hosting<sup>(03)</sup></a></li>
              <li><a href="tutorial-category.php">WordPress Hosting<sup>(06)</sup></a></li>
              <li><a href="tutorial-category.php">Reseller Hosting<sup>(07)</sup></a></li>
              <li><a href="tutorial-category.php">Shared Hosting<sup>(08)</sup></a></li>
              <li><a href="tutorial-category.php">VPS Hosting<sup>(09)</sup></a></li>
            </ul>
          </div>
          ...
          <div class="sidebar-widget recent-post-widget">
            <h4 class="widget-title">Links de Importancia</h4>
            <ul class="mt-30 rs-news-list">
              <li class="d-flex align-items-center">
                <div class="rs-news-content ms-3">
                  <a href="blog-details.html">
