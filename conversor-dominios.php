...
<section class="breadcrumb-area bg-primary-gradient bg-hero-conversor">
  <div class="container">
    <div class="breadcrumb-content text-center">
      <h2 class="mb-3">Conversor de dominios con Ñ y Tilde</h2>
      <p>Este conversor le permite codificar dominios con acentos y ñ (como mipeña.com) <br>a su respectivo código puny (también conocido como IDN o ACE) para poder ser registrado con Inkawebdesign.com.</p>
    </div>
  </div>
</section>
<!--breadcrumb area end-->
...
<!--email service start-->
<section class="email-services ds-bg pt-120 pb-120 overflow-hidden">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <div class="section-title text-center">
          <h2 class="mb-3">Instrucciones</h2>
          <p class="mb-0">Asegurese que su navegador tiene la última versión instalada para su correcto funcionamiento. </p>
        </div>
      </div>
    </div>
      ...
      <div class="row g-4 justify-content-center">
          ...
          <div class="email-service-item text-center">
            <span class="icon-wrapper d-inline-flex align-items-center justify-content-center rounded-circle bg-light-red">
              <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M28.5156 12.2114H13.7546C13.1988 12.2114 12.7482 12.662 12.7482 13.2179C12.7482 13.7737 13.1988 14.2243 13.7546 14.2243H28.5156C29.0715 14.2243 29.5221 13.7737 29.5221 13.2179C29.5221 12.662 29.0715 12.2114 28.5156 12.2114Z" fill="white" />
              </svg>
            </span>
            <h5 class="mt-4 mb-3">1er Paso</h5>
            <p class="mb-0">Introduzca el dominio que desee registrar con acentos o ñ en el campo ORIGINAL, por ejemplo mipeña.com o montaña.com y pulse Encode </p>
          </div>
        </div>
        <div class="col-xl-4 col-md-6 ">
        ...
        <div class="col-xl-4 col-md-6 ">
          <div class="email-service-item text-center">
            ...
            <h5 class="mt-4 mb-3">Nota</h5>
            <p class="mb-0">Le recordamos que los dominios multilingues aún no funcionan en muchos navegadores y sistemas de correo electrónico. </p>
          </div>
        </div>
      </div>
    </div>
...
<section class="cd-cta ds-bg pb-120">
  <div class="container">
    <div class="cd-cta-wrapper bg-primary-gradient--2 rounded-10 text-white card-conversor">
...
<!--faq section start-->
<section class="feature-area pt-120 pb-80" data-background="assets/img/imagenes-inkaweb/bg-shape-1.webp">
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-7">
        <div class="section-title text-center">
